ServerEvents.recipes(drill => {
    ...
    .placement(18, 6, 40825039).biomeWhitelist('cardboard:all_nether')
    ...
    .placement(18, 6, 90156452).biomeWhitelist('minecraft:is_end')
    ...
    .placement(18, 6, 27361576).biomeWhitelist('cardboard:all_deeper_darker')
    ...
    .placement(18, 6, 27363376).alwaysInfinite().biomeWhitelist('terralith:all_terralith_biomes').biomeWhitelist('cardboard:all_nether')
    .id("kubejs:oil_vein");
